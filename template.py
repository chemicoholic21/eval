...
def main():
    ...
    try:
        ...
        df = pd.read_csv("Supahealth (01 sept) - Sheet1.csv", dtype=dtype_dict)
        print(f"📄 Successfully loaded 'Supahealth (01 sept) - Sheet1.csv' with {len(df)} rows.")

        # Process the dataframe
        final_df = process_dataframe(df)

        output_filename = "Supahealth website.csv"
