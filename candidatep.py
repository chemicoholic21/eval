...
def main():
    ...
    try:
        ...
        if os.path.exists("25 Aug - Sheet16.csv"):
            ...
            if not excel_files:
                raise FileNotFoundError("No '25 Aug - backend ads preformat.csv' or .xlsx file found.")
    ...
    # --- Run Stage 2 for ALL candidates (including Advanced, Reject, Manual Intervention) ---
    print("\n" + "="*25 + " GENERATING PROFILES FOR ALL CANDIDATES " + "="*25)
    detailed_profiles_df = run_detailed_profiling(df)
